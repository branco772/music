        ...
        <div>
            ...
            <div className="h-[calc(100vh-7rem)] flex justify-center items-center">
                <form onSubmit={handlerSubmit} encType="multipart/form-data">
                    ...
                    <input type="number" name="orden" placeholder="asignar un orden 1,2,3,4" className="text-black bg-gradient-to-r from-green-100 via-purple-300 to-purple-900 text-lg rounded-2xl  w-full  p-4  my-2" onChange={handlerChange}/>
