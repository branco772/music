    ...
    return(
        <div className="h-[calc(100vh-7rem)] flex justify-center items-center">
            <form onSubmit={handlerSubmit}>
                <input type="text" name="titulo" placeholder="Ingrese Titulo de la cancion"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-lg
                    rounded-lg w-full p-4 my-1"
                onChange={handlerChange} value={newCancion.titulo}/>

                <input type="text" name="artista" placeholder="Ingrese Titulo del artista"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-lg
                    rounded-lg w-full p-4 my-1"
                onChange={handlerChange} value={newCancion.artista}/>
                ...
                <input name="visible" type="checkbox" checked={newCancion.visible} class="sr-only peer"
